...
function App() {
    ...
    useEffect(() => {
      setIsVisible(true);
      // Vérifier si l'utilisateur est déjà connecté (localStorage, etc.)
      ...
      const handleLogin = (loginData) => {
        ...
        const userData = {
              ...
              name: 'Utilisateur Demo', // Remplacer par les données réelles
      ...
      const handleSignup = (signupData) => {
          // Ici, vous intégrerez votre logique d'inscription réelle
  ...
  <section className="cta-section">
    ...
    <div className="container">
      <div className="cta-content">
        <h2>
          {user ? 'Découvrez toutes nos fonctionnalités premium' : 'Prêt à révolutionner votre approche financière ?'}
        </h2>
        <p>
          {user 
            ? `Profitez de l'accès complet à notre plateforme IA et transformez vos processus financiers.`
